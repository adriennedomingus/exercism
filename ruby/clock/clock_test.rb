...
class ClockTest < Minitest::Test
  ...
  def test_add_exactly_an_hour
    clock = Clock.at(10, 20) + 60
    assert_equal '11:20', clock.to_s
  end
  ...
  def test_subtract_more_than_60_minutes
    clock = Clock.at(10) - 90
    assert_equal '08:30', clock.to_s
  end

  def test_subtract_less_than_60_minutes
    clock = Clock.at(10, 30) - 15
    assert_equal '10:15', clock.to_s
  end

  def test_subtract_60_minutes
    clock = Clock.at(10) - 60
    assert_equal '09:00', clock.to_s
  end
