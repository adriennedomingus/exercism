...
class SayTest < Minitest::Test
  ...
  def test_another_hundreds
    assert_equal 'six hundred seventy-two', Say.new(672).in_english
  end
  ...
  def test_more_thousands
    expected = 'one hundred thirty-six thousand nine hundred seventy-two'
    assert_equal expected, Say.new(136972).in_english
  end
